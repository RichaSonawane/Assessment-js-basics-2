...
const downDeal = deals.filter((ele) => ele.title === "15% Off!").map((ele)=>{return ele.title.replace('15','10')});
console.log(downDeal)
console.log("------")
...
//CODE HERE
const secondDeal = deals.filter((ele) => ele.title === "Free Kids Meal with 2 Regular Entrees").
map((ele) => {return ele.desc.replace("March", "April").trim() });
